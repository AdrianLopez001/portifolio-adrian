...
export default function Hero({ config }: { config: any }) {
  ...
  return (
    ...
    >
      ...
      >
        {/* Left: Avatar + Social */}
        <div className="flex flex-col items-center gap-5 lg:pt-2 shrink-0">
        ...
        <div className="flex-1 text-center lg:text-left">
          <div className="section-label mb-3 flex items-center justify-center lg:justify-start gap-2">
            <Briefcase size={12} />
          ...
          <p className="text-base leading-relaxed mb-8" style={{ color: "var(--text-secondary)", maxWidth: "600px" }}>
          ...
          {/* Skills grid */}
          <div className="grid grid-cols-2 gap-3 mb-8" style={{ maxWidth: "560px" }}>
            {skills.map((s) => (
              <div
                key={s.label}
                className="card flex items-start gap-3 p-3 cursor-default"
