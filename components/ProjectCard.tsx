    ...
    >
      ...
      >
        <div className="flex-1 min-w-0">
          ...
          <h3
            className="text-lg font-bold mb-1.5 truncate"
          ...
          >
            {locale === "en" ? (project.shortDescriptionEn || project.shortDescription) : project.shortDescription}
          </p>
        </div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm leading-relaxed" style={{ color: "var(--text-secondary)" }}>
                  {locale === "en" ? (project.problemEn || project.problem) : project.problem}
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm leading-relaxed" style={{ color: "var(--text-secondary)" }}>
                  {locale === "en" ? (project.contributionEn || project.contribution) : project.contribution}
                </p>
              </div>
